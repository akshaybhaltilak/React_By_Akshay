...
//   useEffect (() => {
//     PasswordGenretor
//   }, [lenght, numberAllowed, charAllowed, PasswordGenretor])
  


//   return (
//     <>
//     <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-800 border-4 size-40 '>
